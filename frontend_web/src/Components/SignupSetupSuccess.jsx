      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center px-6 md:px-12 lg:px-20 relative">
        ...
        <div className="w-full max-w-md text-center">
          ...
          <p className="text-gray-600 mb-8">
            You have initialized important details successfully. You can now log in and start using FitFlow.
          </p>
...
export default SignupSetupSuccess;