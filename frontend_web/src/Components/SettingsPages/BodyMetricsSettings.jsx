...
const BodyMetricsSettings = () => {
  ...
  // Check for modifications when form values change
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Build request body with updated metrics
      const requestBody = {
        ...userData,
      ...
      // Update initial values to reflect what's been saved
      setInitialValues({
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., 65"
                className={`w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:outline-none placeholder:text-gray-400 ${
                  !isWeightFocused && weight === initialValues.weight ? "text-gray-400" : "text-black"
                }`}
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., 21"
                className={`w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:outline-none placeholder:text-gray-400 ${
                  !isAgeFocused && age === initialValues.age ? "text-gray-400" : "text-black"
                }`}
              />
            </div>
